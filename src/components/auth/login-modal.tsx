    ...
    >
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row h-full">
          {/* Left Section - Form */}
          <div className="bg-deep-green flex flex-col justify-start gap-[12px] max-w-[370px] pt-9 pb-5">
            <div className="text-center pl-12.5 pr-12 flex flex-col gap-[9px]">
              <h1 className="font-signifier text-2xl lg:text-[2.625rem] font-[100] text-brand-secondary leading-[99%] tracking-[-1px] text-center m-0 p-0 mt-0.5 ml-0.5">
                Build your own<br></br> Bourbon Trail
                <sup className="text-[12px] align-[20px]">TM</sup>
              </h1>
              <p className="font-gt-america font-[300] text-[0.875rem] text-center tracking-[0px] ml-2 leading-[120%] mb-1.75 mt-0.5">
            ...
            <div className="relative text-center ">
              <div className="absolute inset-0 flex items-center mt-1 pl-11 pr-12">
              ...
              <div className=" font-gt-america relative flex justify-center text-[0.75rem] tracking-[0px] leading-[18px]">
                <span className="px-2.5 bg-kbt-deep-green text-brand-secondary pl-1.5">
                  or continue with
                </span>
              </div>
            </div>
              ...
              >
                ...
                <div>
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full font-[100] flex items-center justify-center gap-2 py-3.5 bg-kbt-dark-green text-[#F1EDDD] text-[0.65625rem] uppercase tracking-[0.15em] h-auto disabled:opacity-50 disabled:cursor-not-allowed pb-2.5"
                  >
                    {isLoading ? (
